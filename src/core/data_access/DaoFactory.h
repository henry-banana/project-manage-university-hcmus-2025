...
private:
    ...
    static std::shared_ptr<IDatabaseAdapter> _dbAdapterInstance; ///< Instance duy nhất của database adapter
    static std::mutex _dbAdapterMutex; ///< Mutex để đảm bảo thread-safety khi truy cập database adapter    // Tương tự, giữ các instance của parser để tái sử dụng.
    static std::shared_ptr<IEntityParser<Student, DbQueryResultRow>> _studentSqlParserInstance; ///< Parser instance cho Student
    static std::shared_ptr<IEntityParser<Teacher, DbQueryResultRow>> _teacherSqlParserInstance; ///< Parser instance cho Teacher
    static std::shared_ptr<IEntityParser<Faculty, DbQueryResultRow>> _facultySqlParserInstance; ///< Parser instance cho Faculty
    static std::shared_ptr<IEntityParser<Course, DbQueryResultRow>> _courseSqlParserInstance; ///< Parser instance cho Course
    static std::shared_ptr<IEntityParser<LoginCredentials, DbQueryResultRow>> _loginCredentialsSqlParserInstance; ///< Parser instance cho LoginCredentials
    static std::shared_ptr<IEntityParser<EnrollmentRecord, DbQueryResultRow>> _enrollmentRecordSqlParserInstance; ///< Parser instance cho EnrollmentRecord
    static std::shared_ptr<IEntityParser<CourseResult, DbQueryResultRow>> _courseResultSqlParserInstance; ///< Parser instance cho CourseResult
    static std::shared_ptr<IEntityParser<FeeRecord, DbQueryResultRow>> _feeRecordSqlParserInstance; ///< Parser instance cho FeeRecord
    static std::shared_ptr<IEntityParser<SalaryRecord, DbQueryResultRow>> _salaryRecordSqlParserInstance; ///< Parser instance cho SalaryRecord
    static std::mutex _parserMutex; ///< Mutex để đảm bảo thread-safety khi truy cập parsers
    ...
    /**
     * @brief Lấy hoặc tạo mới parser cho một entity
     * @tparam TEntity Kiểu dữ liệu của entity
     * @return Con trỏ thông minh đến parser tương ứng
     */
    template<typename TEntity>
    static std::shared_ptr<IEntityParser<TEntity, DbQueryResultRow>> getSqlEntityParser();    // Chuyên biệt hóa template cho từng entity
    /**
